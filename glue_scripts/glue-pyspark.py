...
songs_file_path = f's3a://{bucket_name}/spotify-da1/songs/'
users_file_path = f's3a://{bucket_name}/spotify-da1/users/'
user_streams_path = f's3a://{bucket_name}/spotify-da1/user-streams/'
...
output_path = f's3a://{bucket_name}/spotify-da1/output/song_kpis/'
